...
tf.app.flags.DEFINE_float('adagrad_accumulator', 0.1,
                          """Starting Adagrad Accumulator Value""")
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor):
  ...
  with tf.name_scope('train'):
      if FLAGS.optimizer is "Adagrad":
        # Adagrad
        train_step = tf.train.AdagradOptimizer(FLAGS.learning_rate, FLAGS.adagrad_accumulator).minimize(cross_entropy_mean)
